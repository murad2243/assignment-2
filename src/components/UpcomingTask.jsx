            ...
            <div className='client-div'>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <p style={{color:"#7E7E7E"}}>Status</p>
                        <b style={{color:"#F44336", fontSize:"large"}}>OverDue</b>
                        </div>
                        <button className='assessment-btn'>Start Assessment</button>
                    </div>
                </div>
            </div>
            <h4>Wednesday, 27 Dec 2022</h4>
            <div className='client-div'>
                <img src={lady} alt="" />
                <div>
                    <div className='info-div'>
                    ...
                    <div>
                        <div style={{display:"flex", gap:"5px"}}>
                        <p style={{color:"#7E7E7E"}}>Status</p>
                        <b style={{color:"#00B071", fontSize:"large"}}>OverDue</b>
                        </div>
                        <button className='assessment-btn'>Start Assessment</button>
                    </div>
                </div>
